...
public class Q05_Amazon extends TestBase {
    ...
    public void test() {
      ...
      //      urunler = driver.findElements(By.partialLinkText("Apple iPhone"));  // for'un icine ben tekrardan locate koymazsam stale elementReferenceExcp. verir
            urunler.get(i).click();
