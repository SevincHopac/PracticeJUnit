...
public class Q06_Screenshot extends TestBase {
    ...
    public void name() throws IOException, InterruptedException {
        ...
        WebElement result = driver.findElement(By.xpath("//*[@data-component-type='s-result-info-bar']"));
        FileUtils.copyFile(result.getScreenshotAs(OutputType.FILE),new File("target/tumSayfaResmi/"+tarih+".jpeg"));
