...
public class Q15_Sahibinden_CanH extends TestBase {
    ...
    public void setup() {
        ...
        String path = "C:\\Users\\sevin\\AppData\\Local\\Google\\Chrome\\User Data";
 ...
 //       driver.findElement(By.id("onetrust-close-btn-container")).click();
    ...
    public void detayli_Arama_Oda_Sayisi(String odaSayisi, String binaY, String Bkat, int katS, int İsi) {
